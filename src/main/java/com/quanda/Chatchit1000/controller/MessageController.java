package com.quanda.Chatchit1000.controller;
...
public class MessageController {
	...
	public ResponseEntity<List<Message>> getMessageByUsername(@RequestParam("username")String username){
		List<Message> listMessage = messageService.findByUsername(username);
